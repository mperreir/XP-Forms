      ...
      <div className={styles.formViewerContainer}>
        ...
        {!id_participant && formDetails && (
          <div className={styles.formDetails}>
            ...
            <p>
              <strong>Pour intégrer dans un scénario Tobii utilisez :</strong>{" "}
              <a href={`http://localhost:3000/form-viewer/${id}/${page}/@?navigation=True`} target="_blank" rel="noopener noreferrer">
                http://localhost:3000/form-viewer/{id}/{page}/@?navigation=True
              </a>
            </p>
